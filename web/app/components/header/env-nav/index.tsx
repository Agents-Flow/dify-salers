...
const EnvNav = () => {
  ...
  const showEnvTag = agentFlowVersionInfo.current_env === 'TESTING' || agentFlowVersionInfo.current_env === 'DEVELOPMENT'
  ...
  return (
    <div className={`
      ...
      ${headerEnvClassName[agentFlowVersionInfo.current_env]}
    `}
    >
      {
        agentFlowVersionInfo.current_env === 'TESTING' && (
          <>
      ...
      {
        agentFlowVersionInfo.current_env === 'DEVELOPMENT' && (
          <>
